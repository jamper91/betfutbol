<div class="ligas index">
	...
	<tr>
		<td><?php echo h($liga['Liga']['id']); ?>&nbsp;</td>
		<td><?php echo h($liga['Liga']['name']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($liga['Deporte']['name'], array('controller' => 'deportes', 'action' => 'view', $liga['Deporte']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $liga['Liga']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $liga['Liga']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $liga['Liga']['id']), array(), __('Are you sure you want to delete # %s?', $liga['Liga']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
